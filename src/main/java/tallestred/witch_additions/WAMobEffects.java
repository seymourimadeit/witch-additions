...
public class WAMobEffects {
    ...
    public static final DeferredHolder<MobEffect, MobTransformationEffect> AXO_TRANSFORMATION_EFFECT = registerTransformation("axo", EntityType.AXOLOTL, 60, 61403);
    public static final DeferredHolder<MobEffect, MobTransformationEffect> CAT_TRANSFORMATION_EFFECT = registerTransformation("cat", EntityType.CAT, 60, 16350378);
